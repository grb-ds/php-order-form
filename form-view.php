           ...
           <!-- <div class="row">-->
                <div class="col-md-4 order-md-2 mb-4">
                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="badge badge-secondary badge-pill"><?php echo $cart->quantity ?></span>
                    </h4>
                    <ul class="list-group mb-3">
                        ...
                        if (count($cart->items) > 0) :
                            foreach ($cart->items as $key => $item) : ?>
                                <li class="list-group-item d-flex justify-content-between lh-condensed">
                                    ...
                                    <div>
                                        <span class="text-muted"><?php echo $cart->formattedNumber($item->amount) ?></span>
                                        <button class="product_fav" name="removeItem" value="<?php echo $item->code ?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <span>Total (EUR)</span>
                            <strong><?php echo $cart->formattedNumber($cart->total) ?></strong>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="col-md-4">
                            <div class="product py-4">
                                ...
                                <div class="about text-center">
                                    <h5><?php echo $product->name ?></h5> <span> &euro; <?= $product->formattedNumber($product->price) ?></span>
                                </div>
                                <div class="cart-button mt-3 px-2 d-flex justify-content-between align-items-center">
                                    <div class="form-group">
                                        <button class="btn btn-primary text-uppercase" name="addCart" value="<?php echo $product->code ?>">Add to cart</button>
